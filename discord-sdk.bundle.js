(() => {
  ...
  var BigIntegerExports, bigInt;
  var init_BigInteger3 = __esm({
    "node_modules/@discord/embedded-app-sdk/output/_virtual/BigInteger.mjs"() {
      init_commonjsHelpers();
      init_BigInteger();
      BigIntegerExports = requireBigInteger();
      bigInt = /* @__PURE__ */ getDefaultExportFromCjs(BigIntegerExports);
    }
  });
  ...
  var MAX_BIG_INT, SMALL_INT, PARTS, HighLow, SUPPORTS_BIGINT, HIGH_LOW_CACHE, convertToBigFlag, EMPTY_FLAG, flagAnd, flagOr, flagXor, flagNot, flagEquals, getFlag, BigFlagUtils;
  var init_BigFlagUtils = __esm({
    "node_modules/@discord/embedded-app-sdk/output/utils/BigFlagUtils.mjs"() {
      init_BigInteger3();
      MAX_BIG_INT = 64;
      SMALL_INT = 16;
      PARTS = MAX_BIG_INT / SMALL_INT;
      HighLow = class _HighLow {
      ...
      SUPPORTS_BIGINT = checkBrowserSupportsBigInt();
      ...
      HIGH_LOW_CACHE = {};
      convertToBigFlag = SUPPORTS_BIGINT ? function convertToBigFlagBigInt(value) {
        return BigInt(value);
      ...
      EMPTY_FLAG = convertToBigFlag(0);
      flagAnd = SUPPORTS_BIGINT ? function flagAndBigInt(first = EMPTY_FLAG, second = EMPTY_FLAG) {
        return first & second;
      } : function flagAndHighLow(first = EMPTY_FLAG, second = EMPTY_FLAG) {
        return first.and(second);
      };
      flagOr = SUPPORTS_BIGINT ? function flagOrBigInt(first = EMPTY_FLAG, second = EMPTY_FLAG) {
        return first | second;
      } : function flagOrHighLow(first = EMPTY_FLAG, second = EMPTY_FLAG) {
        return first.or(second);
      };
      flagXor = SUPPORTS_BIGINT ? function flagXorBigInt(first = EMPTY_FLAG, second = EMPTY_FLAG) {
        return first ^ second;
      } : function flagXorHighLow(first = EMPTY_FLAG, second = EMPTY_FLAG) {
        return first.xor(second);
      };
      flagNot = SUPPORTS_BIGINT ? function flagNotBigInt(first = EMPTY_FLAG) {
        return ~first;
      } : function flagNotHighLow(first = EMPTY_FLAG) {
        return first.not();
      };
      flagEquals = SUPPORTS_BIGINT ? function flagEqualsBigInt(first, second) {
        return first === second;
  ...
  var RPCCloseCodes, RPCErrorCodes, Orientation, Platform, Permissions, UNKNOWN_VERSION_NUMBER, HANDSHAKE_SDK_VERSION_MINIMUM_MOBILE_VERSION;
  var init_Constants = __esm({
    "node_modules/@discord/embedded-app-sdk/output/Constants.mjs"() {
      ...
      HANDSHAKE_SDK_VERSION_MINIMUM_MOBILE_VERSION = 250;
    }
  });
  ...
  var InitiateImageUploadResponseSchema, OpenShareMomentDialogRequestSchema, AuthenticateRequestSchema, AuthenticateResponseSchema, GetActivityInstanceConnectedParticipantsResponseSchema, ShareInteractionRequestSchema, ShareInteractionResponseSchema, ShareLinkRequestSchema, ShareLinkResponseSchema, GetRelationshipsResponseSchema, InviteUserEmbeddedRequestSchema, GetUserRequestSchema, GetUserResponseSchema, GetQuestEnrollmentStatusRequestSchema, GetQuestEnrollmentStatusResponseSchema, QuestStartTimerRequestSchema, QuestStartTimerResponseSchema, GetQuestResponseSchema, RequestProxyTicketRefreshResponseSchema, Command, emptyResponseSchema, emptyRequestSchema, Schemas;
  var init_schemas = __esm({
    "node_modules/@discord/embedded-app-sdk/output/generated/schemas.mjs"() {
      init_lib();
      init_zodUtils();
      InitiateImageUploadResponseSchema = z.object({ image_url: z.string() }).describe('Response for "INITIATE_IMAGE_UPLOAD" Command');
      OpenShareMomentDialogRequestSchema = z.object({ mediaUrl: z.string().max(1024) }).describe('Request for "OPEN_SHARE_MOMENT_DIALOG" Command');
      AuthenticateRequestSchema = z.object({ access_token: z.union([z.string(), z.null()]).optional() }).describe('Request for "AUTHENTICATE" Command');
      AuthenticateResponseSchema = z.object({
      ...
      GetActivityInstanceConnectedParticipantsResponseSchema = z.object({
      ...
      ShareInteractionRequestSchema = z.object({
        command: z.string(),
      ...
      ShareInteractionResponseSchema = z.object({ success: z.boolean() }).describe('Response for "SHARE_INTERACTION" Command');
      ShareLinkRequestSchema = z.object({
      ...
      ShareLinkResponseSchema = z.object({ success: z.boolean(), didCopyLink: z.boolean(), didSendMessage: z.boolean() }).describe('Response for "SHARE_LINK" Command');
      GetRelationshipsResponseSchema = z.object({
      ...
      InviteUserEmbeddedRequestSchema = z.object({ user_id: z.string(), content: z.string().min(0).max(1024).optional() }).describe('Request for "INVITE_USER_EMBEDDED" Command');
      GetUserRequestSchema = z.object({ id: z.string().max(64) }).describe('Request for "GET_USER" Command');
      GetUserResponseSchema = z.union([
        z.object({
          id: z.string(),
          username: z.string(),
          global_name: z.union([z.string(), z.null()]).optional(),
      ...
      GetQuestEnrollmentStatusRequestSchema = z.object({ quest_id: z.string() }).describe('Request for "GET_QUEST_ENROLLMENT_STATUS" Command');
      GetQuestEnrollmentStatusResponseSchema = z.object({ quest_id: z.string(), is_enrolled: z.boolean(), enrolled_at: z.union([z.string(), z.null()]).optional() }).describe('Response for "GET_QUEST_ENROLLMENT_STATUS" Command');
      QuestStartTimerRequestSchema = z.object({ quest_id: z.string() }).describe('Request for "QUEST_START_TIMER" Command');
      QuestStartTimerResponseSchema = z.object({ success: z.boolean() }).describe('Response for "QUEST_START_TIMER" Command');
      GetQuestResponseSchema = z.object({
        quest_id: z.string(),
      ...
      RequestProxyTicketRefreshResponseSchema = z.object({ ticket: z.string() }).describe('Response for "REQUEST_PROXY_TICKET_REFRESH" Command');
      (function(Command2) {
      ...
      emptyResponseSchema = z.object({}).optional().nullable();
      emptyRequestSchema = z.void();
      Schemas = {
  ...
  var DISPATCH, Commands, ReceiveFramePayload, ScopesObject, Scopes, Relationship, User, GuildMember, GuildMemberRPC, Emoji, VoiceState, UserVoiceState, StatusObject, Status, Activity, PermissionOverwriteTypeObject, PermissionOverwrite, ChannelTypesObject, Channel, PresenceUpdate, Role, Guild, ChannelMention, Attachment, EmbedFooter, Image, Video, EmbedProvider, EmbedAuthor, EmbedField, Embed, Reaction, MessageActivity, MessageApplication, MessageReference, Message, VoiceDevice, KeyTypesObject, ShortcutKey, VoiceSettingModeTypeObject, VoiceSettingsMode, VoiceSettingsIO, CertifiedDeviceTypeObject, CertifiedDevice, SkuTypeObject, Sku, EntitlementTypesObject, Entitlement, OrientationLockStateTypeObject, OrientationLockState, ThermalStateTypeObject, ThermalState, OrientationTypeObject, Orientation2, LayoutModeTypeObject, LayoutMode;
  var init_common = __esm({
    "node_modules/@discord/embedded-app-sdk/output/schema/common.mjs"() {
      ...
      ReceiveFramePayload = objectType({
        cmd: stringType(),
        data: unknownType(),
        evt: nullType(),
        nonce: stringType()
      }).passthrough();
      ScopesObject = Object.assign(Object.assign({}, AuthenticateResponseSchema.shape.scopes.element.overlayType._def.innerType.options[0].Values), { UNHANDLED: -1 });
      Scopes = zodCoerceUnhandledValue(ScopesObject);
      Relationship = GetRelationshipsResponseSchema.shape.relationships.element;
      User = objectType({
        id: stringType(),
        username: stringType(),
      ...
      Status = zodCoerceUnhandledValue(StatusObject);
      Activity = objectType({
        name: stringType(),
        type: numberType(),
      ...
      PermissionOverwrite = objectType({
        id: stringType(),
      ...
      Video = Image.omit({ proxy_url: true });
      EmbedProvider = objectType({
        name: stringType().optional().nullable(),
        url: stringType().optional().nullable()
      });
      EmbedAuthor = objectType({
        name: stringType().optional().nullable(),
        url: stringType().optional().nullable(),
        icon_url: stringType().optional().nullable(),
        proxy_icon_url: stringType().optional().nullable()
      });
      EmbedField = objectType({
        name: stringType(),
        value: stringType(),
        inline: booleanType()
      });
      ...
      MessageActivity = objectType({
        type: numberType(),
        party_id: stringType().optional().nullable()
      });
      MessageApplication = objectType({
        id: stringType(),
      ...
      OrientationLockState = zodCoerceUnhandledValue(OrientationLockStateTypeObject);
      ...
      ThermalState = zodCoerceUnhandledValue(ThermalStateTypeObject);
      OrientationTypeObject = {
        UNHANDLED: -1,
        PORTRAIT: 0,
        LANDSCAPE: 1
      };
      Orientation2 = zodCoerceUnhandledValue(OrientationTypeObject);
      ...
      LayoutMode = zodCoerceUnhandledValue(LayoutModeTypeObject);
    }
  });
  ...
  var ERROR, Events, DispatchEventFrame, ErrorEvent, OtherEvent, EventFrame, EventSchema;
  var init_events = __esm({
    "node_modules/@discord/embedded-app-sdk/output/schema/events.mjs"() {
      ...
      OtherEvent = DispatchEventFrame.extend({
        evt: stringType()
      });
      EventFrame = unionType([DispatchEventFrame, OtherEvent, ErrorEvent]);
      EventSchema = {
        /**
         * @description
  ...
  var init_assertUnreachable = __esm({
    "node_modules/@discord/embedded-app-sdk/output/utils/assertUnreachable.mjs"() {
    }
  });
  ...
  var EmptyResponse, AuthorizeResponse, GetGuildsResponse, GetGuildResponse, GetChannelResponse, GetChannelsResponse, NullableChannelResponse, SelectVoiceChannelResponse, SelectTextChannelResponse, VoiceSettingsResponse, SubscribeResponse, CaptureShortcutResponse, SetActivityResponse, GetSkusResponse, GetEntitlementsResponse, StartPurchaseResponse, SetConfigResponse, UserSettingsGetLocaleResponse, EncourageHardwareAccelerationResponse, GetChannelPermissionsResponse, OpenExternalLinkResponse, GetPlatformBehaviorsResponse, ResponseFrame;
  var init_responses = __esm({
    "node_modules/@discord/embedded-app-sdk/output/schema/responses.mjs"() {
      ...
      init_schemas();
      init_schemas();
      init_assertUnreachable();
      EmptyResponse = objectType({}).nullable();
      AuthorizeResponse = objectType({
        code: stringType()
      });
      GetGuildsResponse = objectType({
        guilds: arrayType(objectType({
          id: stringType(),
          name: stringType()
        }))
      });
      GetGuildResponse = objectType({
        id: stringType(),
        name: stringType(),
        icon_url: stringType().optional(),
        members: arrayType(GuildMember)
      });
      GetChannelResponse = objectType({
        id: stringType(),
        type: zodCoerceUnhandledValue(ChannelTypesObject),
        guild_id: stringType().optional().nullable(),
        name: stringType().optional().nullable(),
      ...
      GetChannelsResponse = objectType({
        channels: arrayType(Channel)
      });
      NullableChannelResponse = GetChannelResponse.nullable();
      SelectVoiceChannelResponse = GetChannelResponse.nullable();
      SelectTextChannelResponse = GetChannelResponse.nullable();
      VoiceSettingsResponse = objectType({
      ...
      SubscribeResponse = objectType({
        evt: stringType()
      });
      CaptureShortcutResponse = objectType({ shortcut: ShortcutKey });
      SetActivityResponse = Activity;
      GetSkusResponse = objectType({ skus: arrayType(Sku) });
      GetEntitlementsResponse = objectType({ entitlements: arrayType(Entitlement) });
      StartPurchaseResponse = arrayType(Entitlement).nullable();
      SetConfigResponse = objectType({
        use_interactive_pip: booleanType()
      });
      UserSettingsGetLocaleResponse = objectType({
        locale: stringType()
      });
      EncourageHardwareAccelerationResponse = objectType({
        enabled: booleanType()
      });
      GetChannelPermissionsResponse = objectType({
        permissions: bigIntType().or(stringType())
      });
      OpenExternalLinkResponse = fallbackToDefault(objectType({ opened: booleanType().or(nullType()) }).default({ opened: null }));
      GetPlatformBehaviorsResponse = objectType({
        iosKeyboardResizesView: optionalType(booleanType())
      });
      ResponseFrame = ReceiveFramePayload.extend({
        cmd: nativeEnumType(Commands),
        evt: nullType()
      });
    }
  ...
  var ClosePayload, IncomingPayload;
  var init_schema = __esm({
    "node_modules/@discord/embedded-app-sdk/output/schema/index.mjs"() {
      ...
      ClosePayload = objectType({
        code: numberType(),
        message: stringType().optional()
      });
      IncomingPayload = objectType({
  ...
  var init_authorize = __esm({
    "node_modules/@discord/embedded-app-sdk/output/commands/authorize.mjs"() {
      ...
      init_responses();
      init_commandFactory();
      authorize = (sendCommand) => commandFactory(sendCommand, Commands.AUTHORIZE, AuthorizeResponse);
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/commands/captureLog.mjs
  var captureLog;
  var init_captureLog = __esm({
    "node_modules/@discord/embedded-app-sdk/output/commands/captureLog.mjs"() {
      init_common();
      init_responses();
      init_commandFactory();
      captureLog = (sendCommand) => commandFactory(sendCommand, Commands.CAPTURE_LOG, EmptyResponse);
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/commands/encourageHardwareAcceleration.mjs
  var encourageHardwareAcceleration;
  var init_encourageHardwareAcceleration = __esm({
    "node_modules/@discord/embedded-app-sdk/output/commands/encourageHardwareAcceleration.mjs"() {
      init_common();
      init_responses();
      init_commandFactory();
      encourageHardwareAcceleration = (sendCommand) => commandFactory(sendCommand, Commands.ENCOURAGE_HW_ACCELERATION, EncourageHardwareAccelerationResponse);
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/commands/getChannel.mjs
  var getChannel;
  var init_getChannel = __esm({
    "node_modules/@discord/embedded-app-sdk/output/commands/getChannel.mjs"() {
      init_common();
      init_responses();
      init_commandFactory();
      getChannel = (sendCommand) => commandFactory(sendCommand, Commands.GET_CHANNEL, GetChannelResponse);
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/commands/getEntitlements.mjs
  var getEntitlements;
  var init_getEntitlements = __esm({
    "node_modules/@discord/embedded-app-sdk/output/commands/getEntitlements.mjs"() {
      init_common();
      init_responses();
      init_commandFactory();
      getEntitlements = (sendCommand) => commandFactory(sendCommand, Commands.GET_ENTITLEMENTS_EMBEDDED, GetEntitlementsResponse);
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/commands/getSkus.mjs
  var getSkus;
  var init_getSkus = __esm({
    "node_modules/@discord/embedded-app-sdk/output/commands/getSkus.mjs"() {
      init_common();
      init_responses();
      init_commandFactory();
      getSkus = (sendCommand) => commandFactory(sendCommand, Commands.GET_SKUS_EMBEDDED, GetSkusResponse);
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/commands/getChannelPermissions.mjs
  var getChannelPermissions;
  var init_getChannelPermissions = __esm({
    "node_modules/@discord/embedded-app-sdk/output/commands/getChannelPermissions.mjs"() {
      init_common();
      init_responses();
      init_commandFactory();
      getChannelPermissions = (sendCommand) => commandFactory(sendCommand, Commands.GET_CHANNEL_PERMISSIONS, GetChannelPermissionsResponse);
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/commands/getPlatformBehaviors.mjs
  var getPlatformBehaviors;
  var init_getPlatformBehaviors = __esm({
    "node_modules/@discord/embedded-app-sdk/output/commands/getPlatformBehaviors.mjs"() {
      init_common();
      init_responses();
      init_commandFactory();
      getPlatformBehaviors = (sendCommand) => commandFactory(sendCommand, Commands.GET_PLATFORM_BEHAVIORS, GetPlatformBehaviorsResponse);
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/commands/openExternalLink.mjs
  var openExternalLink;
  var init_openExternalLink = __esm({
    "node_modules/@discord/embedded-app-sdk/output/commands/openExternalLink.mjs"() {
      init_common();
      init_responses();
      init_commandFactory();
      openExternalLink = (sendCommand) => commandFactory(sendCommand, Commands.OPEN_EXTERNAL_LINK, OpenExternalLinkResponse);
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/commands/openInviteDialog.mjs
  var openInviteDialog;
  var init_openInviteDialog = __esm({
    "node_modules/@discord/embedded-app-sdk/output/commands/openInviteDialog.mjs"() {
      init_common();
      init_responses();
      init_commandFactory();
      openInviteDialog = (sendCommand) => commandFactory(sendCommand, Commands.OPEN_INVITE_DIALOG, EmptyResponse);
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/commands/setActivity.mjs
  var setActivity;
  var init_setActivity = __esm({
    "node_modules/@discord/embedded-app-sdk/output/commands/setActivity.mjs"() {
      init_common();
      init_responses();
      init_commandFactory();
      ...
      setActivity = (sendCommand) => commandFactory(sendCommand, Commands.SET_ACTIVITY, SetActivityResponse);
    }
  });
  ...
  var init_setConfig = __esm({
    "node_modules/@discord/embedded-app-sdk/output/commands/setConfig.mjs"() {
      ...
      init_responses();
      init_commandFactory();
      setConfig = (sendCommand) => commandFactory(sendCommand, Commands.SET_CONFIG, SetConfigResponse);
    }
  });
  ...
  var init_compatCommandFactory = __esm({
    "node_modules/@discord/embedded-app-sdk/output/utils/compatCommandFactory.mjs"() {
      init_lib();
      init_Constants();
      init_common();
  ...
  var fallbackTransform, setOrientationLockState;
  var init_setOrientationLockState = __esm({
    "node_modules/@discord/embedded-app-sdk/output/commands/setOrientationLockState.mjs"() {
      init_common();
      init_responses();
      init_compatCommandFactory();
      ...
      setOrientationLockState = (sendCommand) => compatCommandFactory({
        sendCommand,
  ...
  var startPurchase;
  var init_startPurchase = __esm({
    "node_modules/@discord/embedded-app-sdk/output/commands/startPurchase.mjs"() {
      init_common();
      init_responses();
      init_commandFactory();
      startPurchase = (sendCommand) => commandFactory(sendCommand, Commands.START_PURCHASE, StartPurchaseResponse);
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/commands/userSettingsGetLocale.mjs
  var userSettingsGetLocale;
  var init_userSettingsGetLocale = __esm({
    "node_modules/@discord/embedded-app-sdk/output/commands/userSettingsGetLocale.mjs"() {
      init_common();
      init_responses();
      init_commandFactory();
      userSettingsGetLocale = (sendCommand) => commandFactory(sendCommand, Commands.USER_SETTINGS_GET_LOCALE, UserSettingsGetLocaleResponse);
    }
  });
  ...
  var init_authenticate = __esm({
    "node_modules/@discord/embedded-app-sdk/output/commands/authenticate.mjs"() {
      init_schemas();
      init_commandFactory();
      authenticate = schemaCommandFactory(Command.AUTHENTICATE);
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/commands/getActivityInstanceConnectedParticipants.mjs
  var getActivityInstanceConnectedParticipants;
  var init_getActivityInstanceConnectedParticipants = __esm({
    "node_modules/@discord/embedded-app-sdk/output/commands/getActivityInstanceConnectedParticipants.mjs"() {
      init_schemas();
      init_commandFactory();
      getActivityInstanceConnectedParticipants = schemaCommandFactory(Command.GET_ACTIVITY_INSTANCE_CONNECTED_PARTICIPANTS);
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/commands/getQuest.mjs
  var getQuest;
  var init_getQuest = __esm({
    "node_modules/@discord/embedded-app-sdk/output/commands/getQuest.mjs"() {
      init_schemas();
      init_commandFactory();
      getQuest = schemaCommandFactory(Command.GET_QUEST);
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/commands/getQuestEnrollmentStatus.mjs
  var getQuestEnrollmentStatus;
  var init_getQuestEnrollmentStatus = __esm({
    "node_modules/@discord/embedded-app-sdk/output/commands/getQuestEnrollmentStatus.mjs"() {
      init_schemas();
      init_commandFactory();
      getQuestEnrollmentStatus = schemaCommandFactory(Command.GET_QUEST_ENROLLMENT_STATUS);
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/commands/getRelationships.mjs
  var getRelationships;
  var init_getRelationships = __esm({
    "node_modules/@discord/embedded-app-sdk/output/commands/getRelationships.mjs"() {
      init_schemas();
      init_commandFactory();
      getRelationships = schemaCommandFactory(Command.GET_RELATIONSHIPS);
    }
  });
  ...
  var init_getUser = __esm({
    "node_modules/@discord/embedded-app-sdk/output/commands/getUser.mjs"() {
      init_schemas();
      init_commandFactory();
      getUser = schemaCommandFactory(Command.GET_USER);
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/commands/initiateImageUpload.mjs
  var initiateImageUpload;
  var init_initiateImageUpload = __esm({
    "node_modules/@discord/embedded-app-sdk/output/commands/initiateImageUpload.mjs"() {
      init_schemas();
      init_commandFactory();
      initiateImageUpload = schemaCommandFactory(Command.INITIATE_IMAGE_UPLOAD);
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/commands/inviteUserEmbedded.mjs
  var inviteUserEmbedded;
  var init_inviteUserEmbedded = __esm({
    "node_modules/@discord/embedded-app-sdk/output/commands/inviteUserEmbedded.mjs"() {
      init_schemas();
      init_commandFactory();
      inviteUserEmbedded = schemaCommandFactory(Command.INVITE_USER_EMBEDDED);
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/commands/openShareMomentDialog.mjs
  var openShareMomentDialog;
  var init_openShareMomentDialog = __esm({
    "node_modules/@discord/embedded-app-sdk/output/commands/openShareMomentDialog.mjs"() {
      init_schemas();
      init_commandFactory();
      openShareMomentDialog = schemaCommandFactory(Command.OPEN_SHARE_MOMENT_DIALOG);
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/commands/questStartTimer.mjs
  var questStartTimer;
  var init_questStartTimer = __esm({
    "node_modules/@discord/embedded-app-sdk/output/commands/questStartTimer.mjs"() {
      init_schemas();
      init_commandFactory();
      questStartTimer = schemaCommandFactory(Command.QUEST_START_TIMER);
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/commands/requestProxyTicketRefresh.mjs
  var requestProxyTicketRefresh;
  var init_requestProxyTicketRefresh = __esm({
    "node_modules/@discord/embedded-app-sdk/output/commands/requestProxyTicketRefresh.mjs"() {
      init_schemas();
      init_commandFactory();
      requestProxyTicketRefresh = schemaCommandFactory(Command.REQUEST_PROXY_TICKET_REFRESH);
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/commands/shareInteraction.mjs
  var shareInteraction;
  var init_shareInteraction = __esm({
    "node_modules/@discord/embedded-app-sdk/output/commands/shareInteraction.mjs"() {
      init_schemas();
      init_commandFactory();
      shareInteraction = schemaCommandFactory(Command.SHARE_INTERACTION);
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/commands/shareLink.mjs
  var shareLink;
  var init_shareLink = __esm({
    "node_modules/@discord/embedded-app-sdk/output/commands/shareLink.mjs"() {
      init_schemas();
      init_commandFactory();
      shareLink = schemaCommandFactory(Command.SHARE_LINK);
    }
  });
  ...
  var init_commands = __esm({
    "node_modules/@discord/embedded-app-sdk/output/commands/index.mjs"() {
      ...
      init_authorize();
      init_captureLog();
      init_encourageHardwareAcceleration();
      init_getChannel();
      init_getEntitlements();
      init_getSkus();
      init_getChannelPermissions();
      init_getPlatformBehaviors();
      init_openExternalLink();
      init_openInviteDialog();
      init_setActivity();
      init_setConfig();
      init_setOrientationLockState();
      init_startPurchase();
      init_userSettingsGetLocale();
      init_authenticate();
      init_getActivityInstanceConnectedParticipants();
      init_getQuest();
      init_getQuestEnrollmentStatus();
      init_getRelationships();
      init_getUser();
      init_initiateImageUpload();
      init_inviteUserEmbedded();
      init_openShareMomentDialog();
      init_questStartTimer();
      init_requestProxyTicketRefresh();
      init_shareInteraction();
      init_shareLink();
    }
  });
  ...
  var init_getDefaultSdkConfiguration = __esm({
    "node_modules/@discord/embedded-app-sdk/output/utils/getDefaultSdkConfiguration.mjs"() {
    }
  });
  ...
  var init_console = __esm({
    "node_modules/@discord/embedded-app-sdk/output/utils/console.mjs"() {
      consoleLevels = ["log", "warn", "debug", "info", "error"];
    }
  });
  ...
  var Opcodes, ALLOWED_ORIGINS, DiscordSDK;
  var init_Discord = __esm({
    "node_modules/@discord/embedded-app-sdk/output/Discord.mjs"() {
      ...
      init_events();
      init_Constants();
      init_getDefaultSdkConfiguration();
      init_console();
      init_package_json();
      init_common();
      init_v4();
      ...
      ALLOWED_ORIGINS = new Set(getAllowedOrigins());
      DiscordSDK = class {
        getTransfer(payload) {
          var _a;
          switch (payload.cmd) {
  ...
  var MAX_DIGITS, defaults, Decimal, external, decimalError, invalidArgument, exponentOutOfRange, mathfloor, mathpow, isDecimal, ONE, BASE, LOG_BASE, MAX_SAFE_INTEGER, MAX_E, P, divide, Decimal;
  ...
  var CurrencyCodes, CurrencyExponents;
  var init_PriceConstants = __esm({
    "node_modules/@discord/embedded-app-sdk/output/utils/PriceConstants.mjs"() {
  ...
  var lodash_transformExports;
  var init_index22 = __esm({
    "node_modules/@discord/embedded-app-sdk/output/_virtual/index2.mjs"() {
      init_commonjsHelpers();
      init_lodash();
      lodash_transformExports = requireLodash_transform();
    }
  });
  ...
  var init_patchUrlMappings = __esm({
    "node_modules/@discord/embedded-app-sdk/output/utils/patchUrlMappings.mjs"() {
      init_tslib_es6();
      init_url();
    }
  ...
  var init_output = __esm({
    "node_modules/@discord/embedded-app-sdk/output/index.mjs"() {
      ...
      init_PriceUtils();
      init_mock();
      init_patchUrlMappings();
      ({ Commands: Commands2 } = common_exports);
    }
  });
